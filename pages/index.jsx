    ...
    <div className={dark ? "dark" : ""}>
      <div className="bg-neutral text-dark dark:bg-dark dark:text-neutral min-h-screen">
        ...
        <main className="container m-auto">
          <h1 className="text-6xl max-w-max mx-auto p-2">Work in Progress</h1>
          <div className="mx-auto max-w-max pl-14">
            <Illustration size={500} caption="Boy standing at desk working on his computer" image={dark ? WiPDark : WiPWhite}/>
          </div>  
          <p className="text-xl text-center w-96 mx-auto">The website is under construction, do not hesitate to come back later.</p>
          <div className="mt-4">
            <Link href="/contact">
